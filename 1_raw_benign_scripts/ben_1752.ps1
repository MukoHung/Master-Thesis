...
.RESOURCES
    http://www.lazywinadmin.com/2015/05/powershell-report-expiring-user-accounts.html | https://github.com/lazywinadmin/PowerShell/tree/master/AD-USER-Report_Expiring_users
.NOTES
	Francois-Xavier Cat
...
"@
		...
		# Sending email
		Send-MailMessage -SMTPServer $EmailSMTPServer -From $EmailFrom -To $Emailto -Subject $EmailSubject -Body $body -BodyAsHTML
