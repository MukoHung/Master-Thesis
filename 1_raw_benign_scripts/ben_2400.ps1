...
Task UpdateModuleVersion -depends BuildManifest {
    ./BuildFiles/UpdateModuleVersion.ps1
} -description "Update module version"

task ImportModule -depends UpdateModuleVersion {
