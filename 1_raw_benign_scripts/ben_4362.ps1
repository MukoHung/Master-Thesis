...
.EXAMPLE
Update-PSScriptInfo -FullName .\Private-Repository\Public\Start-ClientPSProfile.ps1 -ChangesMade "blah"

#>
Function Update-PSScriptInfo {
	[Cmdletbinding(HelpURI = 'https://smitpi.github.io/Private-Repository/Update-PSScriptInfo')]
	PARAM(
