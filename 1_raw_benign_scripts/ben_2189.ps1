$LicenseSKUToNameMapping = @{
    ...
    'MICROSOFT_COMMUNICATION_COMPLIANCE'                                         = 'RETIRED - Microsoft Communications Compliance'
