...
$DidItBetterSupportMenu.ClientSize  = '542,725'
...
$Upgrades.Font                   = 'Microsoft Sans Serif,10,style=Bold,Underline'
...
$Permissions.Font                = 'Microsoft Sans Serif,10,style=Bold,Underline'
...
$GetSupport.Font                 = 'Microsoft Sans Serif,10,style=Bold,Underline'
...
$AddRegistryFavorites.Font       = 'Microsoft Sans Serif,9'
...
$SyncScenarios.Font              = 'Microsoft Sans Serif,10,style=Bold,Underline'
...
$Configuration.Font              = 'Microsoft Sans Serif,10,style=Bold,Underline'
