...
# set global variables
	...
	z:\home\src\powershell\sqd\poweropVMbyDatastore.ps1 -mvip $mvip -svip $svip -vcenter $vcenter -vcadmin $vcadmin -vcpass $vcpass -esxhost $esxhost -datastore '*DSCdefault' -powerop 'StopVM' -sfpass $sfpass 
	...
	# power on vm's
	z:\home\src\powershell\sqd\poweropAllVM.ps1 -mvip $mvip -svip $svip -vcenter $vcenter -vcadmin $vcadmin -vcpass $vcpass -esxhost $esxhost -powerop 'StartVM' -sfadmin $sfadmin -sfpass $sfpass  -windowsvm $windowsvm
