...
#Importation des donn�es requises :
...
echo "Merci de choisir le client ?"; echo "";echo "1 => SGD (Par d�faut)";echo "2 => Antares";echo "";
$Client = Read-Host;         
...
echo "";
Write-Host "''Si plusieurs comptes s'affiche ou aucun sgdid. Choisir 'No' ou faite Entr�e''" -ForegroundColor Green;
echo "";echo "";
...
#----------------------------------------------------Reference---------------------------------------------------------------------------------------------------------------
echo "Le compte du R�f�rent ?"; echo "";
