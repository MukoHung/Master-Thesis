...
#  Resource:        https://github.com/spjeff/comb
...
#
#                   Usage - Please adjust lines 25-35 under '# Configuration' for your environment
#
#                   Note - To use the automatic task scheduler function run the script with the '-install' parameter
#
...
$global:configMaxEvents = 100										# maximum number of events from any 1 server
