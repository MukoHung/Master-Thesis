...
# Notify
Write-PSDLog -Message "$( $MyInvocation.MyCommand.Name ): The built in VB Script has been replaced by the script, 
however, the function the VB Script would have done is not yet implemented, sorry, working on this" # Well... apology accepted. 
